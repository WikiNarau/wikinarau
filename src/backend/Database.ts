...
export class Database {
	...
	private seedDatabase() {
		this.createContentRevision(
			...
			`[{"T":"Text","C":[{"T":"p","C":[{"T":"","text":"We are trying to build a platform for collaborative open learning material, you can use and edit any material, even without any registration."}]},{"T":"p","C":[{"T":"","text":"As a first example you can look at the following simple task:"},{"T":"a","C":[{"T":"","text":"Multiple-Choice"}],"href":"http://localhost:2600/berry"}]}]}]`,
		);
		this.createContentRevision(
			"/how-to",
			"root",
